...
private:
    void decode_DataProcessImedShift(u8 *buf, Instruct &inst);
    void decode_Misc(u8 *buf, Instruct &inst);
    void decode_DataProcessRegShift(u8 *buf, Instruct &instt);
    void decode_MultiExtraLoad(u8 *buf, Instruct &inst);
    void decode_DataProcessImed(u8 *buf, Instruct &inst);
    void decode_Undefined(u8 *buf, Instruct &inst);
    void decode_MoveImedToStatusReg(u8 *buf, Instruct &instt);
    void decode_LoadStore(u8 *buf, Instruct &inst);
    void decode_LoadStoreMulti(u8 *buf, Instruct &inst);
    void decode_BranchLink(u8 *buf, Instruct &inst);
    void decode_CoprocessorLoadStore(u8 *buf, Instruct &instt);
    void decode_CoprocessorDataProcess(u8 *buf, Instruct &instt);
    void decode_CoprocessorRegTransfer(u8 *buf, Instruct &inst);
    void decode_SWI(u8 *buf, Instruct &inst);
    void getAddressMode(u8*buf, u16 &mode, Instruct &inst);
    InstructDecoder(){};
    ~InstructDecoder(){};
};
